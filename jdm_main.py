...
def load(filename):
    """Загрузка списка типов некоторово предмета с image, lenght, width"""
    with open("configs/" + filename, "r") as file:
        ...
        for item in items.values():
            ...
            item["image"] = pygame.transform.scale(
                item["image"], (item["width"], item["length"])
            )
        return items


def crash(my_car, traffic_cars, world):
    """обработка столкновения игрока с другой машиной"""
    ...
    while pause:
        ...
        CONTINUE_BUTTON = Button(
            image=pygame.transform.scale(
                pygame.image.load("img/continue.png"), (500, 67)
            ),
            pos=(400, 350),
            text_input=" ",
            font=get_font(75),
        ...
        QUIT_BUTTON = Button(
            image=pygame.transform.scale(pygame.image.load("img/quit.png"), (172, 44)),
            pos=(676, 764),
            text_input=" ",
            font=get_font(75),
            base_color="#d7fcd4",
...
def game_finish_screen(time, score, screen):
    ...
    RESTART_BUTTON = Button(
        image=pygame.transform.scale(pygame.image.load("img/restart.png"), (468, 70)),
        pos=(400, 700),
        text_input=" ",
        font=get_font(75),
        base_color="#d7fcd4",
...
def get_energy(my_car, world):
    """обработка получения энергии от бензина"""
...
def play(choosed_car, choosed_track):
    ...
    road_image = pygame.transform.scale(
        pygame.image.load("img/" + str(choosed_track) + ".jpg"), (800, 800)
    )

    coin_image = pygame.transform.scale(pygame.image.load("img/coin.png"), (80, 80))

    world = World(
        roads=[
            Item(road_image, (400, 400), 15),
            Item(road_image, (400, -400), 15),
            Item(road_image, (400, -1200), 15),
        ],
        time=pygame.time.get_ticks(),
        choosed_track=choosed_track,
    )
    ...
    while world.alive:
        ...
        if world.game_status:
            ...
            time_text = font.render(
                "Time: " + str(world.game_time / 1000), True, (0, 0, 0), (255, 255, 255)
            )
            score_text = font.render(
                "Score: " + str(world.point), True, (0, 0, 0), (255, 255, 255)
            )
            energy_text = font.render(
                "Energy: " + str(my_car.energy), True, (0, 0, 0), (255, 255, 255)
            )
...
def track_menu(choosed_car):
    ...
    while True:
        ...
        TRACK1_BUTTON = Button(
            image=pygame.transform.scale(
                pygame.image.load("img/racetrack.jpg"), (300, 300)
            ),
            pos=(217, 400),
            text_input=" ",
            font=get_font(75),
        ...
        TRACK2_BUTTON = Button(
            image=pygame.transform.scale(
                pygame.image.load("img/racetrack2.jpg"), (300, 300)
            ),
            pos=(583, 400),
            text_input=" ",
            font=get_font(75),
        ...
        PREVIOUS_BUTTON = Button(
            image=pygame.transform.scale(
                pygame.image.load("img/previous.png"), (518, 50)
            ),
            pos=(297, 760),
            text_input=" ",
            font=get_font(75),
...
def main_menu():
    ...
    while True:
        ...
        SUPRA_BUTTON = Button(
            image=pygame.transform.scale(
                pygame.image.load("img/tsboku.png"), (236, 118)
            ),
            pos=(145, 675),
            text_input=" ",
            font=get_font(75),
        ...
        CIVIC_BUTTON = Button(
            image=pygame.transform.scale(
                pygame.image.load("img/csboku.png"), (236, 126)
            ),
            pos=(400, 675),
            text_input=" ",
            font=get_font(75),
        ...
        R34_BUTTON = Button(
            image=pygame.transform.scale(
                pygame.image.load("img/rsboku.png"), (236, 122)
            ),
            pos=(659, 675),
            text_input=" ",
            font=get_font(75),
        ...
        OPTIONS_BUTTON = Button(
            image=pygame.transform.scale(
                pygame.image.load("img/options.png"), (267, 50)
            ),
            pos=(400, 760),
            text_input=" ",
            font=get_font(75),
